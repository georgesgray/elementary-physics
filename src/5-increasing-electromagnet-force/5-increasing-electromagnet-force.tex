...
Despite the spread in the results the difference between the power used in two coil-sets is very clear; although the coil-core area A in the second set is much bigger than the pole-area of the magnets, the second set with the bigger coils need less power to produce the same magnet-lift.
